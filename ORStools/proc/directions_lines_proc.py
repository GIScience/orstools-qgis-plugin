...
class ORSDirectionsLinesAlgo(ORSBaseProcessingAlgorithm):
    ...
    def __init__(self):
        ...
        self.setToolTip(self.PARAMETERS[2], "Dictates the cost. For longer routes don't use Shortest Path.")
        self.setToolTip(self.PARAMETERS[3], "You can optionally perform a Traveling Salesman on the waypoints of each MultiPoint feature. Enabling Traveling Salesman will erase all other advanced configuration and assume the preference to be fastest Advanced Parameters: see the documentation for descriptions.")
