...
class ORSIsochronesLayerAlgo(ORSBaseProcessingAlgorithm):
    def __init__(self):
        ...
        self.setToolTip(self.PARAMETERS[3], "Parameter needs to be a comma-separated list of integer values, no decimal points.")
        self.setToolTip(self.PARAMETERS[4], "Applies a level of generalisation to the isochrone polygons generated as a smoothing_factor between 0 and 100")
        self.setToolTip(self.PARAMETERS[5], "Start treats the location(s) as starting point, destination as goal.")
